<template>
  <div class="list_group _4">
    <p><span class="redtxt">개발용</span> VDI그룹입니다.</p>
  ...
  <ModalAtHomeVdiGroupListClear v-if="isModal.isClearModal" @close="modalFnc" />
  <ModalAtHomeVdiGroupListRegister v-if="isModal.isRegisterModal" @close="modalFnc" />
</template>
<script>
...
export default defineComponent({
  components: {
    ModalAtHomeVdiGroupListClear: defineAsyncComponent(() =>
      import('./modal/ModalAtHomeVdiGroupListClear.vue'),
    ),
    ModalAtHomeVdiGroupListRegister: defineAsyncComponent(() =>
      import('./modal/ModalAtHomeVdiGroupListRegister.vue'),
    ),
  },
  setup() {
